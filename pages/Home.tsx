    ...
    <div className="flex flex-col">
      ...
      <section className="py-24 bg-dark">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-6xl font-display font-black uppercase mb-4">WHY SQUIZZ FITNESS?</h2>
      ...
      <section className="py-24 bg-charcoal">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 space-y-4 md:space-y-0">
            <div>
              <h2 className="text-4xl md:text-6xl font-display font-black uppercase mb-2">SQUIZZ GEAR</h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 className="text-4xl md:text-6xl font-display font-black uppercase mb-8 leading-tight">THE SQUIZZ <br /> COMMUNITY</h2>
              <p className="text-gray-400 text-lg mb-8 italic leading-relaxed">
                "The atmosphere at SQUIZZ fitness is addictive. It's not just a place to workout; it's where I go to push beyond what I thought was possible. The community is elite."
              </p>
